...
static const char *fonts[]          = { "FiraCode Nerd Font Mono:style=Medium:pixelsize=12:antialias=true:autohint=true" };
static const char dmenufont[]       = "FiraCode Nerd Font Mono:style=Medium:pixelsize=12:antialias=true:autohint=true";
static const char col_gray1[]       = "#171b23";
...
static const char *const autostart[] = {
	"picom", "--experimental-backends", NULL, /* TODO use stable picom backend */
	NULL /* terminate */
};
